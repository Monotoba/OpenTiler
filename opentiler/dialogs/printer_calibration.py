from PySide6.QtWidgets import (
    QDialog, QVBoxLayout, QFormLayout, QHBoxLayout, QLabel, QDoubleSpinBox,
...
class PrinterCalibrationDialog(QDialog):
    ...
    def __init__(self, parent, config):
        ...
        self.p_h.setToolTip("Portrait: Horizontal (right) calibration in millimeters.\nShrinks usable width from the right edge by this amount.")
        self.p_v.setToolTip("Portrait: Vertical (bottom) calibration in millimeters.\nShrinks usable height from the bottom edge by this amount.")
        ...
        self.l_h.setToolTip("Landscape: Horizontal (right) calibration in millimeters.\nShrinks usable width from the right edge by this amount.")
        self.l_v.setToolTip("Landscape: Vertical (bottom) calibration in millimeters.\nShrinks usable height from the bottom edge by this amount.")
        ...
        self.p_meas_h = QDoubleSpinBox(); self.p_meas_h.setRange(0.0, 50.0); self.p_meas_h.setSuffix(" mm"); self.p_meas_h.setDecimals(1)
        self.p_meas_v = QDoubleSpinBox(); self.p_meas_v.setRange(0.0, 50.0); self.p_meas_v.setSuffix(" mm"); self.p_meas_v.setDecimals(1)
        self.p_meas_h.setToolTip("From the Portrait ladder sheet: largest visible RIGHT tick in millimeters.")
        self.p_meas_v.setToolTip("From the Portrait ladder sheet: largest visible BOTTOM tick in millimeters.")
        ...
        self.l_meas_h = QDoubleSpinBox(); self.l_meas_h.setRange(0.0, 50.0); self.l_meas_h.setSuffix(" mm"); self.l_meas_h.setDecimals(1)
        self.l_meas_v = QDoubleSpinBox(); self.l_meas_v.setRange(0.0, 50.0); self.l_meas_v.setSuffix(" mm"); self.l_meas_v.setDecimals(1)
        self.l_meas_h.setToolTip("From the Landscape ladder sheet: largest visible RIGHT tick in millimeters.")
        self.l_meas_v.setToolTip("From the Landscape ladder sheet: largest visible BOTTOM tick in millimeters.")
        ...
        apply_btn.setToolTip("Copy measured values into calibration fields; you can then add a small extra if desired.")
