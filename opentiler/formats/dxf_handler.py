...
class DXFHandler:
    ...
    def load_dxf(self, file_path: str) -> Optional[QPixmap]:
        ...
        if not DXF_AVAILABLE:
            QMessageBox.warning(None, "DXF Support", 
        ...
        try:
            ...
            QMessageBox.critical(None, "DXF Load Error", f"Failed to load DXF file:\n{str(e)}")
            return None
    ...
    def save_as_dxf(self, source_pixmap: QPixmap, output_path: str, 
        ...
        try:
            ...
            QMessageBox.critical(None, "DXF Export Error", f"Failed to export DXF file:\n{str(e)}")
            return False
