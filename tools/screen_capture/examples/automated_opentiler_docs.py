...
class OpenTilerDocumentationGenerator:
    ...
    def __init__(
        ...
        output_dir: str = "../../../docs/images/screenshots",
    ):
        ...
        self.screenshot_sequence = [
            ...
            {
                "name": "edit-menu",
                "description": "Edit menu opened",
                "action": "open_edit_menu",
            },
            # View menu
            {
                "name": "view-menu",
                "description": "View menu opened",
                "action": "open_view_menu",
            },
            {
                "name": "zoom-controls",
                "description": "Zoom controls demonstration",
                "action": "demonstrate_zoom",
            },
            # Tools menu
            {
                "name": "tools-menu",
                "description": "Tools menu opened",
            ...
            {
                "name": "help-menu",
                "description": "Help menu opened",
                "action": "open_help_menu",
            },
            {
                "name": "about-dialog",
            ...
            # Workflow demonstrations
            {
                ...
                "description": "Document viewer with plan loaded",
                "action": "show_document_viewer",
            },
            {
                "name": "preview-panel",
                "description": "Preview panel with tiles",
                "action": "show_preview_panel",
            },
            {
                "name": "toolbar-detail",
            ...
            {
                "name": "export-preview",
                "description": "Export preview window",
                "action": "show_export_preview",
            },
            {
    ...
    def generate_all_documentation(self) -> Dict[str, bool]:
        ...
        try:
            ...
            for i, screenshot in enumerate(self.screenshot_sequence, 1):
                print(
                    f"📸 [{i:2d}/{len(self.screenshot_sequence)}] {screenshot['description']}"
                )
