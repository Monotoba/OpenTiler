...
from PySide6.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QCheckBox, QSpinBox, QLabel, QGroupBox
    ...
    def _handle_measurement_start(self, context: HookContext) -> bool:
        ...
        if start_point and isinstance(start_point, QPointF):
            ...
            if snap_point:
                ...
                self.snap_plugin.log_info(f"Snapped start point to {snap_point.x():.1f}, {snap_point.y():.1f}")
