...
class LinuxPackageBuilder:
    ...
    def check_fpm(self):
        ...
        try:
            ...
            print("Or on Ubuntu/Debian: sudo apt-get install ruby-dev build-essential && gem install fpm")
            return False
...
'''
    ...
    def build_deb_package(self):
        ...
        cmd = [
            ...
            "--after-install", str(self.package_dir / "postinst"),
            "--before-remove", str(self.package_dir / "prerm"),
            "--package", str(self.dist_dir),
            "-C", str(self.package_dir),
            "usr"
        ]
    ...
    def build_packages(self, formats):
        ...
        if success:
            ...
            packages = list(self.dist_dir.glob("*.deb")) + list(self.dist_dir.glob("*.rpm"))
...
def main():
    ...
    parser.add_argument("--format", choices=["deb", "rpm", "both"], 
                       default="both", help="Package format to build")
